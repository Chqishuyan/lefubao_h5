...
var _vueInfiniteLoading = __webpack_require__(45);
...
var vm = new _vue2.default({
    ...
    methods: {
        ...
        fentchData: function fentchData(page) {
            ...
            base.useAjax({
                ...
                data: {
                    ...
                    posSn: "",
                    status: "",
                    sign: base.useMd5([{ loginKey: this.loginKey }, { pageNum: page }, { posSn: "" }, { status: "" }])
                },
        ...
        onInfinite: function onInfinite() {
            ...
            base.useAjax({
                ...
                data: {
                    ...
                    posSn: "",
                    status: "",
                    sign: base.useMd5([{ loginKey: this.loginKey }, { pageNum: this.page }, { posSn: "" }, { status: "" }])
                },
                success: function success(data) {
